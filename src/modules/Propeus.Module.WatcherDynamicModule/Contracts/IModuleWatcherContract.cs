...
namespace Propeus.Module.WatcherDynamicModule.Contracts
{
    ...
    /// </summary>
    [ModuleContract(typeof(WatcherModule))]
    public interface IModuleWatcherContract : IModule
    {
        /// <summary>
        ...
        Type BuildModuleTypeFromContract(Type contractType);
        ...
        Type GetModuleTypeFromContract(Type contractType);
        bool HasModuleTypeFromContract(Type contractType);
    }
}