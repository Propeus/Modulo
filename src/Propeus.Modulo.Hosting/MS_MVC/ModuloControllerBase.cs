...
namespace Propeus.Modulo.Hosting.MS_MVC
{
    ...
    public class ModuloControllerBase : ModuloBase
    {
            ...
            get
            {
                if (_metadataProvider == null)
                {
                    ...
                    else
                    {
                        ...
                        metadataProvider = requestServices != null ? requestServices.GetRequiredService<IModelMetadataProvider>() : null;
                    }
        ...
        public IModelBinderFactory ModelBinderFactory
        {
            get
            {
                if (_modelBinderFactory == null)
                {
                    ...
                    {
                        IServiceProvider requestServices = httpContext.RequestServices;
                        modelBinderFactory = requestServices != null ? requestServices.GetRequiredService<IModelBinderFactory>() : null;
                    }
        ...
        public IUrlHelper Url
        {
            get
            {
                if (_url == null)
                {
                    ...
                    {
                        IServiceProvider requestServices = httpContext.RequestServices;
                        obj = requestServices != null ? requestServices.GetRequiredService<IUrlHelperFactory>() : null;
                    }

                    _url = ((IUrlHelperFactory)obj)?.GetUrlHelper(ControllerContext);
                }
        ...
        public IObjectModelValidator ObjectValidator
        {
            get
            {
                if (_objectValidator == null)
                {
                    ...
                    {
                        IServiceProvider requestServices = httpContext.RequestServices;
                        objectValidator = requestServices != null ? requestServices.GetRequiredService<IObjectModelValidator>() : null;
                    }
        ...
        {
            return AcceptedAtAction(actionName, (object)null, null);
        }
