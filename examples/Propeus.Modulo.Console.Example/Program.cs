...
namespace Propeus.Modulo.Console.Example
{
    ...
    internal class Program
    {
        ...
        private static void ExemploPropeusModuloDinamico()
        {
             ...
             * **/
            using (IModuleManager gerenciador = Propeus.Modulo.Dinamico.ModuleManagerExtensions.CreateModuleManagerDefault(ModuleManagerExtensions.CreateModuleManager()))
            {
             ...
             * **/
            using (IModuleManagerArguments gerenciador = Propeus.Modulo.Dinamico.ModuleManagerExtensions.CreateModuleManagerDefault(ModuleManagerExtensions.CreateModuleManager()) as IModuleManagerArguments)
            {
        ...
        private static void ExemploPropeusModuloCore()
        {
             ...
             * más ao chamar a propriedade Propeus.ModuleProxy.Core.ModuleManagerExtensions.CreateModuleManagerDefault() Uma nova instancia será criada
             * **/
