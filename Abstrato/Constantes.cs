...
namespace Propeus.Modulo.Abstrato
{
    ...
    {
        //Constante para relato de erro em parâmetros com tipo diferente do especificado
        ...
        //Constante para relato de erro em parâmetros com valores nulos ou vazios
        ...
        //Constante para relato de objeto obsoleto
        public const string OBSOLETO_REMOCAO = "O método será removido nas próximas versões.";
        //Constante para relato de erro em parâmetros com objetos herdados de Attribute
        public const string PARAMETRO_ATRIBUTO_INVALIDO = "Não é possível obter atributos de um tipo herdado de Attribute";
        //Constante para relato de erro em parâmetros não convertidos para o tipo especificado
        public const string PARAMETRO_NAO_CONVERTIDO = "Não foi possível converter o parâmetro '{0}' para '{1}'.";
        //Constante para relato de erro ao tentar encontrar o caminho do próprio executável
        ...
        public const string TIPO_NAO_CONVERTIDO = "Constante para relato de erro em tipos de conversão explicita";
