...
using Propeus.Modulo.Dinamico.Teste.Contrato;
using Propeus.Modulo.Dinamico.Teste.Modulo;
using Propeus.Modulo.Modelos.Interfaces;
using System;
using System.IO;
using System.Linq;

namespace Propeus.Modulo.Dinamico.Teste
{
    ...
    public class GerenciadorTeste : IDisposable
    {
        ...
        {
#if DEBUG
            Copiar("Propeus.Modulo.Dinamico.Teste.Modulo", modo: "Debug");
#else
             Copiar("Propeus.Modulo.Dinamico.Teste.Modulo",modo:"Release");
#endif
