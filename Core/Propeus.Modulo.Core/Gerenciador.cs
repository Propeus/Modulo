using Propeus.Modulo.Core.Properties;
...
using Propeus.Modulo.Util.Outros;
...
namespace Propeus.Modulo.Core
{
    public sealed class Gerenciador : BaseModelo, IGerenciador, IGerenciadorRegistro
    {
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            {
                throw new ObjectDisposedException(Resources.ERRO_GERENCIADOR_DESATIVADO);
            }
        }
