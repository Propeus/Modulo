using Propeus.Modulo.Util.Genericos;
...
namespace Propeus.Modulo.Util.Tipos
{
    ...
    public static partial class Helper
    {
        ...
        public static bool Herdado(this Type obj, Type comparacao)
        {
            ...
            if (obj.IsVoid())
            {
                throw new ArgumentException(string.Format(Resources.ARGUMENTO_NAO_PODE_SER_DO_TIPO, typeof(void).Name), nameof(obj));
            }
            ...
            {
                throw new ArgumentException(string.Format(Resources.ARGUMENTO_NAO_PODE_SER_DO_TIPO, typeof(void).Name), nameof(comparacao));
            }
        ...
        public static object Default(this Type obj)
        {
            ...
            throw new InvalidCastException(string.Format(Resources.VALOR_PADRAO_NAO_ENCONTRADO, nameof(obj)));
        }
        ...
        public static bool ExisteMetodo(this Type obj, MethodInfo mth)
        {
            ...
            if (mth.IsNull())
            {
                throw new ArgumentNullException(nameof(mth), Resources.ARGUMENTO_NULO);
            }
        ...
        public static bool ExisteMetodo(this Type obj, Action action)
        {
            ...
            if (action.IsNull())
            {
                throw new ArgumentNullException(nameof(action), Resources.ARGUMENTO_NULO);
            }
        ...
        public static PropertyInfo ObterPropriedade(this Type obj, PropertyInfo prop)
        {
            ...
            if (prop.IsNull())
            {
                throw new ArgumentNullException(nameof(prop), Resources.ARGUMENTO_NULO);
            }
        ...
        public static EventInfo ObterEvento(this Type obj, EventInfo evt)
        {
            ...
            if (evt.IsNull())
            {
                throw new ArgumentNullException(nameof(evt), Resources.ARGUMENTO_NULO);
            }
