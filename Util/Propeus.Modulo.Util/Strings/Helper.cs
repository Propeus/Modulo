...
namespace Propeus.Modulo.Util.Strings
{
    ...
    public static partial class Helper
    {
        ...
        public static string[] FirstSplit(this string str, char separator)
        {
            ...
            {
                throw new ArgumentNullException(nameof(str), Resources.ARGUMENTO_NULO_OU_VAZIO);
            }
            if (separator.IsNullOrDefault())
            {
                throw new ArgumentNullException(nameof(separator), Resources.ARGUMENTO_NULO_OU_VAZIO);
            }
        ...
        public static string FirstReplace(this string str, string antigo, string novo)
        {
            ...
            {
                throw new ArgumentNullException(nameof(antigo), Resources.ARGUMENTO_NULO_OU_VAZIO);
            }
