...
namespace Propeus.Modulo.Util.Genericos
{
    /// <summary>
    ...
    public static partial class Helper
    {
            ...
            where TDe : class
        {
            if (de.IsNull())
            {
                throw new ArgumentNullException(nameof(de), Resources.ARGUMENTO_NULO);
            }
        ...
        public static object ObterValorPropriedade<TClase>(this TClase obj, PropertyInfo property)
        {
            ...
            if (property.IsNull())
            {
                throw new ArgumentNullException(nameof(property), Resources.ARGUMENTO_NULO);
            }
